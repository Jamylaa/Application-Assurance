...
public class Pack {
   ...
   //IDs des packs d'autres produits pouvant être combinés avec celui-ci dans un contrat multi-risques.
    private List<String> packsCompatibles;
   // IDs des packs exclusifs — souscrire l'un exclut l'autre (ex: deux niveaux du même produit).
