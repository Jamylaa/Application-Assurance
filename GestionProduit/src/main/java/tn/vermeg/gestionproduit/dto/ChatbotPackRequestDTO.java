...
public class ChatbotPackRequestDTO {
    ...
    private List<ComplexGuaranteeExtractionService.ExtractedGuarantee> complexGaranties;
    ...
    public ChatbotPackRequestDTO() {
        ...
        this.complexGaranties = new ArrayList<>();
        this.domainesMedicaux = new ArrayList<>();
    ...
    public List<String> getGaranties() { return garanties; }
    public void setGaranties(List<String> garanties) { this.garanties = garanties; }

    public List<ComplexGuaranteeExtractionService.ExtractedGuarantee> getComplexGaranties() { return complexGaranties; }
    public void setComplexGaranties(List<ComplexGuaranteeExtractionService.ExtractedGuarantee> complexGaranties) { this.complexGaranties = complexGaranties; }
    ...
    public void applyDefaults() {
        // N'appliquer des valeurs par défaut que si le champ n'a PAS été explicitement défini
        // Utiliser null comme indicateur de "non détecté" au lieu de 0
        ...
        // Ne plus appliquer de valeur par défaut pour couvertureGeographique - laisser null si non détecté
        ...
        // Ne plus appliquer de valeur par défaut pour niveauCouverture - laisser null si non détecté
        ...
        // Ne plus appliquer de valeur par défaut pour prixMensuel - laisser null si non détecté
        // if (this.prixMensuel == null) {
